...
import (
	...
	"github.com/etfx-dev/go-etfx/core/bloombits"
	"github.com/etfx-dev/go-etfx/core/rawdb"
	"github.com/etfx-dev/go-etfx/core/types"
	"github.com/etfx-dev/go-etfx/core/vm"
	"github.com/etfx-dev/go-etfx/eth/downloader"
	"github.com/etfx-dev/go-etfx/eth/filters"
	...
	"github.com/etfx-dev/go-etfx/miner"
...
func New(ctx *node.ServiceContext, config *Config) (*Ethereum, error) {
	...
	if !config.SkipBcVersionCheck {
		if bcVersion != nil && *bcVersion > core.BlockChainVersion {
			return nil, fmt.Errorf("database version is v%d, Getfx %s only supports v%d", *bcVersion, params.VersionWithMeta, core.BlockChainVersion)
