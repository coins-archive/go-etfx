...
import (
	...
	"github.com/etfx-dev/go-etfx/internal/jsre"
	"github.com/etfx-dev/go-etfx/internal/web3ext"
...
// Welcome show summary of current Getfx instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Getfx metadata
	fmt.Fprintf(c.printer, "Welcome to the Getfx JavaScript console!\n\n")
	c.jsre.Run(`
