...
# 1. install getfx for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for getfx
# 5. create getfx, attach and uninstall start menu entries
...
function .onInit
  # make vars are global for all users since getfx is installed global
