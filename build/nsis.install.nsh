Name "getfx ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/etfx-dev/go-etfx/issues"
!define UPDATEURL "https://github.com/etfx-dev/go-etfx/releases"
...
# Install getfx binary
Section "Getfx" GETFX_IDX
  SetOutPath $INSTDIR
  file {{.Getfx}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\getfx.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\getfx.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Getfx incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Getfx outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Getfx UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Getfx incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\getfx.exe" "" "" "Ethereum" 30303 "" "" ""
  SimpleFC::AdvAddRule "Getfx outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\getfx.exe" "" "" "Ethereum" "" 30303 "" ""
  SimpleFC::AdvAddRule "Getfx UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\getfx.exe" "" "" "Ethereum" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\getfx.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\getfx.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GETFX_IDX}
    SectionGetSize ${GETFX_IDX} $0
