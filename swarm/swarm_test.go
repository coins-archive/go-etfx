...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/getfx.ipc",
			endpoint:    "/data/testnet/getfx.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/getfx.ipc",
			endpoint:    "/data/testnet/getfx.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/getfx.ipc",
			endpoint:    "/data/testnet/getfx.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/getfx.ipc",
			endpoint:    "/data/testnet/getfx.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
