...
import (
	...
	"github.com/etfx-dev/go-etfx/graphql"
...
func loadConfig(file string, cfg *getfxConfig) error {
	f, err := os.Open(file)
	if err != nil {
		return err
	}
...
func defaultNodeConfig() node.Config {
	...
	cfg.IPCPath = "getfx.ipc"
	return cfg
}

func makeConfigNode(ctx *cli.Context) (*node.Node, getfxConfig) {
	// Load defaults.
	cfg := getfxConfig{
