...
import (
	...
	"github.com/etfx-dev/go-etfx/internal/debug"
	...
	"github.com/etfx-dev/go-etfx/swarm"
	bzzapi "github.com/etfx-dev/go-etfx/swarm/api"
	swarmmetrics "github.com/etfx-dev/go-etfx/swarm/metrics"
	"github.com/etfx-dev/go-etfx/swarm/storage/mock"
	mockrpc "github.com/etfx-dev/go-etfx/swarm/storage/mock/rpc"
	"github.com/etfx-dev/go-etfx/swarm/tracing"
...
// This init function sets defaults so cmd/swarm can run alongside getfx.
func init() {
...
func bzzd(ctx *cli.Context) error {
	...
	//getfx only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for getfx and swarm
