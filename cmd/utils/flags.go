...
import (
	...
	"github.com/etfx-dev/go-etfx/accounts/keystore"
	"github.com/etfx-dev/go-etfx/common"
	"github.com/etfx-dev/go-etfx/common/fdlimit"
	"github.com/etfx-dev/go-etfx/consensus"
	"github.com/etfx-dev/go-etfx/consensus/clique"
	"github.com/etfx-dev/go-etfx/consensus/ethash"
	"github.com/etfx-dev/go-etfx/core"
	"github.com/etfx-dev/go-etfx/core/vm"
	"github.com/etfx-dev/go-etfx/crypto"
	"github.com/etfx-dev/go-etfx/dashboard"
	"github.com/etfx-dev/go-etfx/eth"
	"github.com/etfx-dev/go-etfx/eth/downloader"
	"github.com/etfx-dev/go-etfx/eth/gasprice"
	"github.com/etfx-dev/go-etfx/ethdb"
	"github.com/etfx-dev/go-etfx/ethstats"
	"github.com/etfx-dev/go-etfx/les"
	"github.com/etfx-dev/go-etfx/log"
	"github.com/etfx-dev/go-etfx/metrics"
	"github.com/etfx-dev/go-etfx/metrics/influxdb"
	...
	"github.com/etfx-dev/go-etfx/p2p/nat"
	"github.com/etfx-dev/go-etfx/p2p/netutil"
...
// for Getfx and returns half of the allowance to assign to the database.
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `getfx account list`)")
	log.Warn("-------------------------------------------------------------------")
...
func SetupMetrics(ctx *cli.Context) {
	if metrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(metrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "getfx.", tagsMap)
		}
	}
}
...
// new format.
//
// e.g. getfx account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// getfx --keystore /tmp/mykeystore --lightkdf account new
//
